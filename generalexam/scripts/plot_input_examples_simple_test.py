...
FIRST_HEIGHT_MATRIX_METRES = numpy.full((17, 33), 1000.)
SECOND_HEIGHT_MATRIX_METRES = numpy.full((17, 33), 500.)
...
THIS_EXAMPLE1_MATRIX = numpy.stack((
    FIRST_TEMP_MATRIX_KELVINS, FIRST_HEIGHT_MATRIX_METRES,
...
THIS_EXAMPLE2_MATRIX = numpy.stack((
    SECOND_TEMP_MATRIX_KELVINS, SECOND_HEIGHT_MATRIX_METRES,
