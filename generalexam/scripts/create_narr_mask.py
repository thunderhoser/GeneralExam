...
def _plot_front_counts(num_fronts_matrix, colour_map_object, output_file_name):
    ...
    num_fronts_matrix[num_fronts_matrix == 0] = numpy.nan
    ...
    plotting_utils.add_linear_colour_bar(
        ...
        colour_max=max_colour_value, orientation='vertical', extend_min=False,
        extend_max=True)
...
def _run(top_frontal_grid_dir_name, first_time_string, last_time_string,
         dilation_distance_metres, output_dir_name):
    """Creates mask, indicating where human forecasters usually draw fronts.
    ...
    pickle_file_name = '{0:s}/front_counts.p'.format(output_dir_name)
    print 'Writing grids of warm- and cold-front counts to: "{0:s}"...'.format(
        pickle_file_name)
