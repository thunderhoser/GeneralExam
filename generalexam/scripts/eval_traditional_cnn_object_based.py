...
MIN_LENGTH_HELP_STRING = (
    'Minimum length of skeleton line (across diagonal of bounding box).  '
    'Smaller ones will be thrown out.')
...
def _evaluate_model(
    ...
    :param min_object_length_metres: Minimum length of skeleton line (across
        diagonal of bounding box).  Smaller ones will be thrown out.
