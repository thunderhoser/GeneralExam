...
FIELD_COMBO_ABBREVS = [
    'u-v-thetaw', 'u-v-T-q', 'u-v-T-q-thetaw', 'u-v-thetaw-p',
    'u-v-T-q-p', 'u-v-T-q-thetaw-p'
]
FIELD_COMBO_STRINGS = [
...
PRESSURE_COMBO_ABBREVS = [
    'surface', '1000mb', 'surface+1000', 'surface+0950', 'surface+0900',
    'surface+0850'
]
        ...
        for i in range(num_conv_block_counts):
            for j in range(num_pressure_combos):
                for k in range(num_field_combos):
                    for m in range(num_conv_layer_counts):
                        this_eval_file_name = (
                            '{0:s}/era5_cnn_{1:s}/{2:s}_num-conv-blocks={3:d}_'
