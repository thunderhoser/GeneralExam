"""Plots schematic of simple front."""
...
def _plot_temperature_grid(temperature_matrix_kelvins):
    ...
    colour_bar_object.set_label('Density')
...
def _overlay_text(axes_object):
    ...
    axes_object.text(
        X_OFFSET_RIGHT, FIRST_ROW_IN_FRONT + 1, 'Front',
        fontsize=OVERLAY_FONT_SIZE, color=OVERLAY_COLOUR,
        horizontalalignment='center', verticalalignment='center'
    )

    axes_object.text(
        X_OFFSET_RIGHT, LAST_ROW_IN_FRONT, 'Front',
        fontsize=OVERLAY_FONT_SIZE, color=OVERLAY_COLOUR,
        horizontalalignment='center', verticalalignment='center'
    )
