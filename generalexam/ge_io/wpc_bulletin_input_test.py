"""Unit tests for wpc_bulletin_input.py."""
...
class WpcBulletinInputTests(unittest.TestCase):
    """Each method is a unit test for wpc_bulletin_input.py."""
    ...
    def test_string_to_latlng_5chars(self):
        ...
        this_latitude_deg, this_longitude_deg = (
            wpc_bulletin_input._string_to_latlng(LATLNG_STRING_5CHARS))
    ...
    def test_string_to_latlng_7chars(self):
        ...
        this_latitude_deg, this_longitude_deg = (
            wpc_bulletin_input._string_to_latlng(LATLNG_STRING_7CHARS))
        self.assertTrue(numpy.isclose(
    ...
    def test_string_to_latlng_5chars_invalid(self):
        ...
        with self.assertRaises(ValueError):
            wpc_bulletin_input._string_to_latlng(LATLNG_STRING_5CHARS_BAD)
    ...
    def test_string_to_latlng_7chars_invalid(self):
        ...
        with self.assertRaises(ValueError):
            wpc_bulletin_input._string_to_latlng(LATLNG_STRING_7CHARS_BAD)
    ...
    def test_string_to_latlng_8chars(self):
        ...
        with self.assertRaises(ValueError):
            wpc_bulletin_input._string_to_latlng(LATLNG_STRING_8CHARS)
    ...
    def test_file_name_to_valid_time(self):
        ...
        this_time_unix_sec = wpc_bulletin_input._file_name_to_valid_time(
            BULLETIN_FILE_NAME)
