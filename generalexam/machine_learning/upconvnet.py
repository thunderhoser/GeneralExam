...
def train_upconvnet(
        ...
        last_training_time_unix_sec, narr_predictor_names, num_half_rows,
        num_half_columns, num_examples_per_batch, cnn_model_object,
        cnn_feature_layer_name, num_epochs, num_training_batches_per_epoch,
        output_model_file_name, num_validation_batches_per_epoch=None,
    ...
    :param narr_predictor_names: See doc for `training_generator`.
    ...
    training_generator = trainval_generator(
        ...
        narr_predictor_names=narr_predictor_names, num_half_rows=num_half_rows,
